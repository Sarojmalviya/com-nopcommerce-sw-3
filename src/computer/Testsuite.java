...
//            2.20 Verify the Text “Welcome, Please Sign In!”
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"),"Saroj");   //insert username
        sendTextToElement(By.id("BillingNewAddress_LastName"),"Malviya");         //insert lastname
        sendTextToElement(By.id("BillingNewAddress_Email"),"sheetalkikani123@gmail.com");    //insert random email id
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"),"Raynerslane");   //insert address
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"),"ha03sx");           //insert postcode
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"),"07721541514");     //enter user phone number
        Thread.sleep(2000);
        ...
        sendTextToElement(By.id("CardholderName"),"Saroj");
        ...
        sendTextToElement(By.id("CardCode"),"124");
